...
//맵에서 방문을 했는지 확인하기 위한 배열, bool을 {}로 초기화하면 false로 초기화됨(int일때는 0으로 초기화되는 걸로 생각)
bool visited[mazeSize][mazeSize] = {};

//전달한 미로의 위치가 이동 가능한지 판단하는 함수
// row-행-y축값 | col-열-x축 값
